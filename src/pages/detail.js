...
const Detail = () => {
  ...
  return (
    <div>
        <h2 className='text-3xl text-center  text-white'>PRODUCT DETAIL</h2>
        <div className='grid grid-cols-2 gap-5 mt-5'>
            <div>
                <img src={detail.image} alt="" className='w-full'/>
            </div>
            <div className='flex flex-col gap-5'>
                <h1 className='text-4xl uppercase font-bold  text-white'>{detail.name}</h1>
                ...
                <div className='flex gap-5'>
                    ...
                    <button className='bg-red-600 text-white px-7 py-3 rounded-xl shadow-2xl' onClick={handleAddToCart}>
                        Add To Cart
                    </button>
                </div>
